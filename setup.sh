...
sleep 1
wget https://raw.githubusercontent.com/basikal123/test/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
...
wget https://raw.githubusercontent.com/basikal123/test/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
